...
public:
    ...
    LoraMac(LoraMacHelper *mac, RadioHandler *r, RegionBase *b);
    ...
    */
    ...
    void MacMcpsConfirm(std::function<void(McpsConfirm_t *McpsConfirm)> callback, McpsConfirm_t *McpsConfirm);
    void MacMcpsIndication(std::function<void(McpsIndication_t *McpsIndication)> callback, McpsIndication_t *McpsIndication);
    void MacMlmeConfirm(std::function<void(MlmeConfirm_t *MlmeConfirm)> callback, MlmeConfirm_t *MlmeConfirm);
