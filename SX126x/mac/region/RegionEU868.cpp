...
RegionEU868::RegionEU868(RadioHandler *r){

    radio = r;
}

uint32_t RegionEU868::GetBandwidth(uint32_t drIndex)
{
...
bool RegionEU868::VerifyTxFreq(uint32_t freq, uint8_t *band)
{
...
uint8_t RegionEU868::CountNbOfEnabledChannels(bool joined, uint8_t datarate, uint16_t *channelsMask, ChannelParams_t *channels, Band_t *bands, uint8_t *enabledChannels, uint8_t *delayTx)
{
...
PhyParam_t RegionEU868::RegionGetPhyParam(GetPhyParams_t *getPhy)
{
...
void RegionEU868::RegionSetBandTxDone(SetBandTxDoneParams_t *txDone)
{
	RegionCommonSetBandTxDone(txDone->Joined, &Bands[Channels[txDone->Channel].Band], txDone->LastTxDoneTime);
}

void RegionEU868::RegionInitDefaults(InitType_t type)
{
	switch (type)
	{
	case INIT_TYPE_INIT:
...
bool RegionEU868::RegionVerify(VerifyParams_t *verify, PhyAttribute_t phyAttribute)
{
	switch (phyAttribute)
	{
	case PHY_TX_DR:
...
void RegionEU868::RegionApplyCFList(ApplyCFListParams_t *applyCFList)
{
...
bool RegionEU868::RegionChanMaskSet(ChanMaskSetParams_t *chanMaskSet)
{
...
bool RegionEU868::RegionAdrNext(AdrNextParams_t *adrNext, int8_t *drOut, int8_t *txPowOut, uint32_t *adrAckCounter)
{
...
void RegionEU868::RegionComputeRxWindowParameters(int8_t datarate, uint8_t minRxSymbols, uint32_t rxError, RxConfigParams_t *rxConfigParams)
{
	double tSymbol = 0.0;
...
bool RegionEU868::RegionRxConfig(RxConfigParams_t *rxConfig, int8_t *datarate)
{
	RadioModems_t modem;
...
bool RegionEU868::RegionTxConfig(TxConfigParams_t *txConfig, int8_t *txPower, TimerTime_t *txTimeOnAir)
{
	RadioModems_t modem;
...
uint8_t RegionEU868::RegionLinkAdrReq(LinkAdrReqParams_t *linkAdrReq, int8_t *drOut, int8_t *txPowOut, uint8_t *nbRepOut, uint8_t *nbBytesParsed)
{
	uint8_t status = 0x07;
...
uint8_t RegionEU868::RegionRxParamSetupReq(RxParamSetupReqParams_t *rxParamSetupReq)
{
	uint8_t status = 0x07;
...
uint8_t RegionEU868::RegionNewChannelReq(NewChannelReqParams_t *newChannelReq)
{
	uint8_t status = 0x03;
	ChannelAddParams_t channelAdd;
	ChannelRemoveParams_t channelRemove;
...
int8_t RegionEU868::RegionTxParamSetupReq(TxParamSetupReqParams_t *txParamSetupReq)
{
	return -1;
}

uint8_t RegionEU868::RegionDlChannelReq(DlChannelReqParams_t *dlChannelReq)
{
	uint8_t status = 0x03;
	uint8_t band = 0;
...
int8_t RegionEU868::RegionAlternateDr(AlternateDrParams_t *alternateDr)
{
	int8_t datarate = 0;
...
void RegionEU868::RegionCalcBackOff(CalcBackOffParams_t *calcBackOff)
{
...
bool RegionEU868::RegionNextChannel(NextChanParams_t *nextChanParams, uint8_t *channel, TimerTime_t *time, TimerTime_t *aggregatedTimeOff)
{
	uint8_t nbEnabledChannels = 0;
	uint8_t delayTx = 0;
...
LoRaMacStatus_t RegionEU868::RegionChannelAdd(ChannelAddParams_t *channelAdd)
{
	uint8_t band = 0;
...
bool RegionEU868::RegionChannelsRemove(ChannelRemoveParams_t *channelRemove)
{
...
void RegionEU868::RegionSetContinuousWave(ContinuousWaveParams_t *continuousWave)
{
...
uint8_t RegionEU868::RegionApplyDrOffset(uint8_t downlinkDwellTime, int8_t dr, int8_t drOffset)
{
