...
public:
    RegionBase();
    int8_t GetNextLowerTxDr(int8_t dr, int8_t minDr);
    int8_t LimitTxPower(int8_t txPower, int8_t maxBandTxPower, int8_t datarate, uint16_t *channelsMask);
    virtual uint32_t GetBandwidth(uint32_t drIndex) = 0;
    virtual bool VerifyTxFreq(uint32_t freq, uint8_t *band) = 0;
    virtual uint8_t CountNbOfEnabledChannels(bool joined, uint8_t datarate, uint16_t *channelsMask, ChannelParams_t *channels, Band_t *bands, uint8_t *enabledChannels, uint8_t *delayTx) = 0;
     ...
     */
    //virtual bool RegionIsActive(LoRaMacRegion_t region) = 0;
     ...
     */
    virtual PhyParam_t RegionGetPhyParam(GetPhyParams_t *getPhy) = 0;
     ...
     */
    virtual void RegionSetBandTxDone(SetBandTxDoneParams_t *txDone) = 0;
     ...
     */
    virtual void RegionInitDefaults(InitType_t type) = 0;
     ...
     */
    virtual bool RegionVerify(VerifyParams_t *verify, PhyAttribute_t phyAttribute) = 0;
     ...
     */
    virtual void RegionApplyCFList(ApplyCFListParams_t *applyCFList) = 0;
     ...
     */
    virtual bool RegionChanMaskSet(ChanMaskSetParams_t *chanMaskSet) = 0;
     ...
     */
    virtual bool RegionAdrNext(AdrNextParams_t *adrNext, int8_t *drOut, int8_t *txPowOut, uint32_t *adrAckCounter) = 0;
     ...
     */
    virtual bool RegionRxConfig(RxConfigParams_t *rxConfig, int8_t *datarate) = 0;
     ...
     */
    virtual void RegionComputeRxWindowParameters(int8_t datarate, uint8_t minRxSymbols, uint32_t rxError, RxConfigParams_t *rxConfigParams) = 0;
     ...
     * \retval Returns true, if the configuration was applied successfully.
     */
    virtual bool RegionTxConfig(TxConfigParams_t *txConfig, int8_t *txPower, TimerTime_t *txTimeOnAir) = 0;
     ...
     */
    virtual uint8_t RegionLinkAdrReq(LinkAdrReqParams_t *linkAdrReq, int8_t *drOut, int8_t *txPowOut, uint8_t *nbRepOut, uint8_t *nbBytesParsed) = 0;
     ...
     * \retval Returns the status of the operation, according to the LoRaMAC specification.
     */
    virtual uint8_t RegionRxParamSetupReq(RxParamSetupReqParams_t *rxParamSetupReq) = 0;
     ...
     * \retval Returns the status of the operation, according to the LoRaMAC specification.
     */
    virtual uint8_t RegionNewChannelReq(NewChannelReqParams_t *newChannelReq) = 0;
     ...
     */
    virtual int8_t RegionTxParamSetupReq(TxParamSetupReqParams_t *txParamSetupReq) = 0;
     ...
     * \retval Returns the status of the operation, according to the LoRaMAC specification.
     */
    virtual uint8_t RegionDlChannelReq(DlChannelReqParams_t *dlChannelReq) = 0;
     ...
     */
    virtual int8_t RegionAlternateDr(AlternateDrParams_t *alternateDr) = 0;
     ...
     */
    virtual void RegionCalcBackOff(CalcBackOffParams_t *calcBackOff) = 0;
     ...
     */
    virtual bool RegionNextChannel(NextChanParams_t *nextChanParams, uint8_t *channel, TimerTime_t *time, TimerTime_t *aggregatedTimeOff) = 0;
     ...
     */
    virtual LoRaMacStatus_t RegionChannelAdd(ChannelAddParams_t *channelAdd) = 0;
     ...
     */
    virtual bool RegionChannelsRemove(ChannelRemoveParams_t *channelRemove) = 0;
     ...
     */
    virtual void RegionSetContinuousWave(ContinuousWaveParams_t *continuousWave) = 0;
     ...
     */
    uint8_t virtual RegionApplyDrOffset(uint8_t downlinkDwellTime, int8_t dr, int8_t drOffset) = 0;
